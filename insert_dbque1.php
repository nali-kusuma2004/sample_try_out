...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=2';
$res=mysqli_query($conn,$sql);
global $ai2;
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=6';
$res=mysqli_query($conn,$sql);
global $ai4;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=10';
$res=mysqli_query($conn,$sql);
global $ai6;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=14';
$res=mysqli_query($conn,$sql);
global $ai8;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=18';
$res=mysqli_query($conn,$sql);
global $ai10;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=22';
$res=mysqli_query($conn,$sql);
global $ai12;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=26';
$res=mysqli_query($conn,$sql);
global $ai14;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_physics where ques_id=30';
$res=mysqli_query($conn,$sql);
global $ai16;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=34';
$res=mysqli_query($conn,$sql);
global $ai18;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=38';
$res=mysqli_query($conn,$sql);
global $ai20;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=42';
$res=mysqli_query($conn,$sql);
global $ai22;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=46';
$res=mysqli_query($conn,$sql);
global $ai24;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=50';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=54';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=58';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=62';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=66';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_physics where ques_id=70';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=74';
$res=mysqli_query($conn,$sql);
global $xi1;         
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=78';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=82';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=86';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_physics where ques_id=90';
$res=mysqli_query($conn,$sql);
global $xi1 ;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=94';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_physics where ques_id=98';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=3';
$res=mysqli_query($conn,$sql);
global $xi1;
...
$sql1="select * from answers_eee where option_id='$xi1'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=5';
$res=mysqli_query($conn,$sql);
global $xi2;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$xi2'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=7';
$res=mysqli_query($conn,$sql);
global $xi3;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$xi3'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=9';
$res=mysqli_query($conn,$sql);
global $xi4;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$xi4'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=10';
$res=mysqli_query($conn,$sql);
global $xi5;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$xi5'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=12';
$res=mysqli_query($conn,$sql);
global $xi6;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$xi6'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=15';
$res=mysqli_query($conn,$sql);
global $xi7;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$xi7'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
include 'conn.php';
$sql='select * from question_eee where ques_id=17';
$res=mysqli_query($conn,$sql);
global $xi8;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=18';
$res=mysqli_query($conn,$sql);
global $xi9;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$xi9'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=20';
$res=mysqli_query($conn,$sql);
global $xi10;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$xi10'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=22';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=24';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=25';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=27';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=28';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=33';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=37';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=38';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=39';
$res=mysqli_query($conn,$sql);
global $xi1;         
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=40';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=41';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=44';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=45';
$res=mysqli_query($conn,$sql);
global $xi1 ;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=49';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=50';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=52';
$res=mysqli_query($conn,$sql);
global $xi1 ;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=55';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=56';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=58';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=59';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=64';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=65';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=66';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=67';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=70';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=71';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=74';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=76';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=78';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=80';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=82';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=84';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=86';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=89';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=90';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=91';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=94';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=93';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=99';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=102';
$res=mysqli_query($conn,$sql);
global $ai2;
...
$sql1="select * from answers_eee where option_id='$ai2'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=104';
$res=mysqli_query($conn,$sql);
global $ai4;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai4'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=107';
$res=mysqli_query($conn,$sql);
global $ai6;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai6'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
$sql1="select * from answers_eee where option_id='$ai8'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=11';
$res=mysqli_query($conn,$sql);
global $ai10;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai10'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=112';
$res=mysqli_query($conn,$sql);
global $ai12;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai12'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=114';
$res=mysqli_query($conn,$sql);
global $ai14;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai14'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
include 'conn.php';
$sql='select * from question_eee where ques_id=21';
$res=mysqli_query($conn,$sql);
global $ai16;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai16'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=118';
$res=mysqli_query($conn,$sql);
global $ai18;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai18'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=120';
$res=mysqli_query($conn,$sql);
global $ai20;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai20'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=123';
$res=mysqli_query($conn,$sql);
global $ai22;
if(mysqli_num_rows($res))
{
...
$sql1="select * from answers_eee where option_id='$ai22'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=124';
$res=mysqli_query($conn,$sql);
global $ai24;
if(mysqli_num_rows($res))
{
...
}$sql1="select * from answers_eee where option_id='$ai24'";
$res1=mysqli_query($conn,$sql1);
if(mysqli_num_rows($res1))
{
while($row=mysqli_fetch_assoc($res1))
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=126';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=130';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=85';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=134';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=136';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=139';
$res=mysqli_query($conn,$sql);
global $xi1;         
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=143';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=145';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=148';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=149';
$res=mysqli_query($conn,$sql);
global $xi1 ;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=150';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=152';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=153';
$res=mysqli_query($conn,$sql);
global $xi1;
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=155';
$res=mysqli_query($conn,$sql);
global $xi2;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=157';
$res=mysqli_query($conn,$sql);
global $xi3;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=159';
$res=mysqli_query($conn,$sql);
global $xi4;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=161';
$res=mysqli_query($conn,$sql);
global $xi5;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=163';
$res=mysqli_query($conn,$sql);
global $xi6;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=164';
$res=mysqli_query($conn,$sql);
global $xi7;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id="167"';
$res=mysqli_query($conn,$sql);
global $xi8;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=168';
$res=mysqli_query($conn,$sql);
global $xi9;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=173';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=174';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=176';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=178';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=183';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=184';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=187';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=189';
$res=mysqli_query($conn,$sql);
global $xi1;         
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=190';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=192';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php
include 'conn.php';
$sql='select * from question_eee where ques_id=195';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
include 'conn.php';
$sql='select * from question_eee where ques_id=196';
$res=mysqli_query($conn,$sql);
global $xi1 ;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=198';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
...
<?php 
include 'conn.php';
$sql='select * from question_eee where ques_id=199';
$res=mysqli_query($conn,$sql);
global $xi1;
if(mysqli_num_rows($res))
{
