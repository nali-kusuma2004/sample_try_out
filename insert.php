...
<tr><td><p>Name:<?php  echo $name;?></P></td>
<td><p>Student Id:<?php echo $id;?></P></td></tr>
<tr><td><p>college name:<?php  echo $college ;?></P></td>
<td><p>course:<?php echo  $course;?></P></td></tr>
</table>
</div>
...
<body class="mn">
    ...
    <div class="sub-heading">
        <h2>Comuputer Science and Engineering</h2>
