...
<ul><li>
                <input type="radio" name="q1" value="1" ><label id="option1"></label></li>
                <hr class="solid">
               <li> <input type="radio" name="q1" value="2" ><label id="option2"></label></li>
                <hr class="solid">
               <li> <input type="radio" name="q1" value="3" ><label id="option3"></label></li>
                <hr class="solid">
               <li> <input type="radio" name="q1" value="4" ><label id="option4"></label></li>
</ul>
    ...
    <div class="buttons">
        <button onclick="prevQuestion()" name="previous" class="button btn-primary">Prev</button>
       <button onclick="nextQuestion()" class="form-group" name="next"  class="nextbtn">Next</button>
       <div class="button submitBtn"><form action="resultpage.php" ><button name="submit" onclick="onclickSubmit()"  class="nextbtn">Submit</button></form></div> 
...
<?php
$sq='insert into exam_result(ques_id,selected_answer,correct_answer) values ("?> i<?php","?> Selected<?php 
"," ")';
  ...
  },
{
 ...
 { 
  ...
  },
  {
    ...
    options: ["<?php echo $x198_1 ;?>", "<?php echo $x198_2 ;?>", "<?php echo $x198_3 ;?>", "<?php echo $x198_4 ;?>"],
